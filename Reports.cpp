  ...
  if (signature_file) {
    for (size_t i = 0; i < repVulns.size(); i++) {
      ...
      fwprintf_s(signature_file,
                 L"Source: Manifest Vendor: %s, Manifest Version: %s, Apache Commons Text Version: %s\n",
                 vuln.manifestVendor.c_str(), vuln.manifestVersion.c_str(), vuln.apacheCommonsTextVersion.c_str()
      );
      fwprintf_s(signature_file,
                 L"Path=%s\n",
                 vuln.file.c_str()
      ...
      fwprintf_s(signature_file,
                 L"Apache Commons Text %s\n",
                 vuln.apacheCommonsTextVersion.c_str()
      );
