...
constexpr wchar_t* qualys_program_data_legacy_location =  L"%SystemDrive%\\Documents and Settings\\All Users\\Application Data\\Qualys\\Text4Scan";
constexpr wchar_t* qualys_program_data_location = L"%ProgramData%\\Qualys\\Text4Scan";
